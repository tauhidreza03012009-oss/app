...
function buildExplorableApartment(scene, world, R, x, z, w, floorH, d, floors) {
  ...
  for (let i = 0; i < floors; i++) {
    ...
    if (i === 0) {
      ...
      createRigidMesh(buildingGroup, world, R, x + (w - rampW) / 2, yBase + 0.1, z + d / 3, rampW, 0.2, d / 3, redFloorMat);
      createRigidMesh(buildingGroup, world, R, x + (w - rampW) / 2, yBase + 0.1, z , rampW, 0.2, d / 3, redFloorMat);
    }
